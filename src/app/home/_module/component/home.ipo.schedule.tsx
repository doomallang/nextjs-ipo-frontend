...
import style from '../css/ipo.schedule.module.css'
...
export default function HomeIpoSchedule() {
  return (
    <div className={style.ipoScheduleContainer}>
      <ContentsTitle text={TitleText.IPO_SCHEDULE} />
